...
namespace Model
{
    public class Usuario : Auditoria
    {
        ...
        public bool extornaFicticias { get { return this.permisoList.Where(u => u.codigo.Equals(Constantes.EXTORNA_FICTICIAS)).FirstOrDefault() != null; } }
        ...
        public bool marcaClientePrioritario { get { return this.permisoList.Where(u => u.codigo.Equals(Constantes.MARCA_CLIENTE_PRIORITARIO)).FirstOrDefault() != null; } }
