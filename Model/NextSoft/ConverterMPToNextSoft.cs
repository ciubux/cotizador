...
namespace Model.NextSoft
{
    public static class ConverterMPToNextSoft
    {
        ...
        public static object toGuiaFE(GuiaRemision obj, List<DetalleVenta> detallesVentaRelacionada)
        {
            ...
            string motivoTraslado = "01";
            switch (obj.motivoTraslado)
            {
                case GuiaRemision.motivosTraslado.Venta: motivoTraslado = "01"; break;
                case GuiaRemision.motivosTraslado.TrasladoInterno: motivoTraslado = "04"; break;
                case GuiaRemision.motivosTraslado.TransferenciaGratuitaEntregada: motivoTraslado = "01"; break;
            }
            ...
            var item = new
            {
                ...
                Serie = obj.serieDocumento, // REVISAR
                Numero = obj.numeroDocumento, // SALIDA
                FecEmision = obj.fechaEmision.ToString("yyyy-MM-dd"),
                Observaciones = obj.observaciones,
                //vendedor = "46124367",
                ...
                FecTraslado = obj.fechaTraslado.ToString("yyyy-MM-dd"),
                ...
                UbigeoPartida = obj.almacen.ubigeo.Id,
                UbigeoLlegada = obj.ubigeoEntrega.Id,
