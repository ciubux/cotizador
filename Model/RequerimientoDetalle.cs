...
namespace Model
{
    public class RequerimientoDetalle : DocumentoDetalle
    {
        public RequerimientoDetalle(Boolean visualizaCostos, Boolean visualizaMargen)
        {
        ...
        public Int64 idRequerimientoDetalle { get; set; }
