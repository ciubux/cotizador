...
namespace Model
{
    public class ProductoControlStock : Auditoria
    {
        ...
        public int cantidadSugeridaPedirCs { get { return (this.cantidadVirtualCs - this.cantidadSolicitudReservaActiva) >= this.cantidadAlerta ? 0 : this.cantidadMaxima - this.cantidadVirtualCs + this.cantidadSolicitudReservaActiva; } }
