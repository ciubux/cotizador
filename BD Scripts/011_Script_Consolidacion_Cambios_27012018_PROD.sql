...
--	SELECT TOP 5 * FROM COTIZACION_DETALLE
	...
	and (cl.id_cliente = @id_cliente or @id_cliente = '00000000-0000-0000-0000-000000000000')
...
/*
DECLARE @codigoCliente varchar(30);
DECLARE @codigoMP varchar(30);
DECLARE @nombre varchar(30);
DECLARE @observacionesDireccionEntrega varchar(30);*/
...
if ( @numero IS NULL OR @numero = '') AND  @numeroPedido  = 0 AND @numeroGuiaRemision = 0
	...
	and (cl.id_cliente = @idCliente or  @idCliente = '00000000-0000-0000-0000-000000000000'
	)
