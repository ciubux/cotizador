...
namespace Cotizador.ExcelExport
{
    ...
    public class NotaIngresoSearch
    {
        public FileStreamResult generateExcel(List<NotaIngreso> list)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                UtilesHelper.setValorCelda(sheet, 1, "A", "N° Nota Ingreso", titleCellStyle);
                ...
                foreach (NotaIngreso obj in list)
                {
                    UtilesHelper.setValorCelda(sheet, i, "A", obj.serieNumeroNotaIngreso);
                    ...
                    UtilesHelper.setValorCelda(sheet, i, "I", obj.ciudadDestino.nombre);
                ...
                using (MemoryStream tempStream = new MemoryStream())
                {
                    ...
                    result.FileDownloadName = "NotasIngreso_" + DateTime.Now.ToString("yyyyMMddHHmmss") + " .xls";
