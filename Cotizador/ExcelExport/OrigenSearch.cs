...
namespace Cotizador.ExcelExport
{
    ...
    public class OrigenSearch
    {
        public FileStreamResult generateExcel(List<Origen> list, Usuario usuario)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                using (MemoryStream tempStream = new MemoryStream())
                {
                    ...
                    result.FileDownloadName = "Origenes_" + DateTime.Now.ToString("yyyyMMddHHmmss") + " .xls";
