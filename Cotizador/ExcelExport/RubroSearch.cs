...
namespace Cotizador.ExcelExport
{
    ...
    public class RubroSearch
    {
        public FileStreamResult generateExcel(List<Rubro> list, Usuario usuario)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                // create sheet
                sheet = (HSSFSheet)wb.CreateSheet("Rubros");
                ...
                using (MemoryStream tempStream = new MemoryStream())
                {
                    ...
                    result.FileDownloadName = "Rubros_" + DateTime.Now.ToString("yyyyMMddHHmmss") + " .xls";
