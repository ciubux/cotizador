    ...
    public class KardexExcel
    {
        ...
        public FileStreamResult generateExcel(Cotizacion obj)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                UtilesHelper.combinarCeldas(sheet, 1, 1, "F", "K");
                UtilesHelper.setValorCelda(sheet, 1, "F", "DETALLE DEL INVENTARIO VALORIZADO", ocTitleCellStyle);
                ...
                string letraInicioEtiqueta = "";
                string letraInicioDescripcion = "";


                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "PERÍODO:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "RUC:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "RAZÓN SOCIAL:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "ESTABLECIMIENTO:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "CODIGO DE LA EXISTENCIA:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "TIPO:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "01 Mercaderias");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "DESCRIPCIÓN:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "CÓDIGO DE LA UNIDAD DE MEDIDA:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "");

                UtilesHelper.setValorCelda(sheet, i, letraInicioEtiqueta, "METODO DE VALUACIÓN:", formLabelCellStyle);
                UtilesHelper.setValorCelda(sheet, i++, letraInicioDescripcion, "Promedio");

                i++;

                UtilesHelper.setRowHeight(sheet, i, 540);
                UtilesHelper.setValorCelda(sheet, i, "A", "COMPROBANTE DE PAGO", titleDataCellStyle);
                UtilesHelper.combinarCeldas(sheet, i, i, "A", "D");
                UtilesHelper.setValorCelda(sheet, i, "E", "TIPO DE OPERACIÓN", titleDataCellStyle);
                UtilesHelper.combinarCeldas(sheet, i, i+1, "E", "E");
                UtilesHelper.setValorCelda(sheet, i, "F", "ENTRADAS", titleDataCellStyle);
                UtilesHelper.combinarCeldas(sheet, i, i, "F", "H");
                UtilesHelper.setValorCelda(sheet, i, "I", "SALIDAS", titleDataCellStyle);
                UtilesHelper.combinarCeldas(sheet, i, i, "I", "K");
                UtilesHelper.setValorCelda(sheet, i, "L", "SALDO FINAL", titleDataCellStyle);
                UtilesHelper.combinarCeldas(sheet, i, i, "L", "N");

                i++;

                UtilesHelper.setRowHeight(sheet, i, 540);
                UtilesHelper.setValorCelda(sheet, i, "A", "FECHA", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "B", "TIPO", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "C", "SERIE", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "D", "DOCUMENTO", titleDataCellStyle);

                UtilesHelper.setValorCelda(sheet, i, "F", "CANTIDAD", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "G", "COSTO UNITARIO", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "H", "COSTO TOTAL", titleDataCellStyle);

                UtilesHelper.setValorCelda(sheet, i, "I", "CANTIDAD", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "J", "COSTO UNITARIO", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "K", "COSTO TOTAL", titleDataCellStyle);

                UtilesHelper.setValorCelda(sheet, i, "L", "CANTIDAD", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "M", "COSTO UNITARIO", titleDataCellStyle);
                UtilesHelper.setValorCelda(sheet, i, "N", "COSTO TOTAL", titleDataCellStyle);


                UtilesHelper.setColumnWidth(sheet, "A", 3500);
                UtilesHelper.setColumnWidth(sheet, "B", 3500);
                UtilesHelper.setColumnWidth(sheet, "C", 3500);
                UtilesHelper.setColumnWidth(sheet, "D", 3500);

                UtilesHelper.setColumnWidth(sheet, "E", 3500);

                UtilesHelper.setColumnWidth(sheet, "F", 3500);
                ...
                UtilesHelper.setColumnWidth(sheet, "K", 3500);
