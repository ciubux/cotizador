        ...
        public FileStreamResult generateUploadExcel(List<Producto> list, Usuario usuario)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                foreach (Producto obj in list)
                {
                    ...
                    UtilesHelper.setValorCelda(sheet, i, "J", (double)obj.equivalenciaUnidadPedidoProveedor);
                    ...
                    UtilesHelper.setValorCelda(sheet, i, "AV", obj.codigoFactorUnidadAlternativa);
