...
namespace Cotizador.ExcelExport
{
    ...
    {
        public FileStreamResult generateExcel(List<DocumentoVenta> list)
        {
            ...
            HSSFSheet sheet;
            {
                ...
                foreach (DocumentoVenta obj in list)
                {
               ...
               MemoryStream ms = new MemoryStream();
                using (MemoryStream tempStream = new MemoryStream())
                {
                    ...
                    result.FileDownloadName = "Facturas_" + DateTime.Now.ToString("yyyyMMddHHmmss") + " .xls";
