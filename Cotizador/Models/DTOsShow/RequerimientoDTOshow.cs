...
namespace Cotizador.Models.DTOshow
{
    public class RequerimientoDTOshow
    {
        ...
        public List<Model.RequerimientoDetalle> requerimientoDetalleList { get; set; }
        ...
        public Model.Requerimiento.tiposRequerimiento tipoRequerimiento { get; set; }
