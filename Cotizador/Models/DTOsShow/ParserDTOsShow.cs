...
namespace Cotizador.Models.DTOsShow
{
    public class ParserDTOsShow
    {
        ...
        public static GuiaRemisionDTOshow GuiaRemisionToGuiaRemisionDTO(GuiaRemision guiaRemision)
        {
            ...
            guiaRemisionDTOshow.habilitaFacturaPedidoRelacionadoExterno =
                guiaRemision.entregaTerceros && guiaRemision.pedido.empresaRelacionada.codigo.Equals(Constantes.EMPRESA_CODIGO_TECNICA) 
                && !guiaRemision.facturadoExterno ? 
                    true : false;
            guiaRemisionDTOshow.estaFacturadoExterno = guiaRemision.facturadoExterno;
            ...
            guiaRemisionDTOshow.extornoRequiereFacturar = guiaRemision.fechaEmision.AddDays(Constantes.DIAS_VALIDO_EXTORNO_GUIA_MES_ANTERIOR).CompareTo(DateTime.Now) < 0 && 
                guiaRemision.fechaEmision.Month < DateTime.Now.Month && !guiaRemision.estaFacturado && guiaRemision.pedido != null && guiaRemision.pedido.clasePedido == Pedido.ClasesPedido.Venta;
