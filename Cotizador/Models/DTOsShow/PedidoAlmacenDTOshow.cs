...
{
    public class PedidoAlmacenDTOshow
    {
        ...
        public String tiposPedidoAlmacenString { get; set; }
        ...
        public String cliente_ciudad_nombre { get; set; }
        public Model.Pedido.tiposPedidoAlmacen tipoPedidoAlmacen { get; set; }
