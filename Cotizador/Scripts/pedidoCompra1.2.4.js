            ...
            success: function (detalle) {
             ...
             /*   var esRecotizacion = "";
                ...
                $("#tableDetallePedido tbody").append('<tr data-expanded="true">' +
                    ...
                    '<td class="' + detalle.idProducto + ' detbtnMostrarPrecios"> <button  type="button" class="' + detalle.idProducto + ' btnMostrarPrecios btn btn-primary bouton-image botonPrecios"></button>' +
...
*/
    ...
    function cargarStockProductos() {
        $.ajax({
            url: "/PedidoCompra/GetStockProductos",
            type: 'POST',
            dataType: 'JSON',
