      ...
      //  $("#tableDetalleCotizacion > tbody").empty();
        ...
        $.ajax({
            ...
            success: function (resultado) {
                ...
                $("#verCliente").html(cotizacion.cliente_razonSocial);
        ...
        $.ajax({
            ...
            success: function (cotizacionList) {
                ...
                for (var i = 0; i < cotizacionList.length; i++) {
                    ...
                    var observacion = cotizacionList[i].seguimientoCotizacion_observacion == null ? "" : cotizacionList[i].seguimientoCotizacio_observacion;
                    ...
                    var cotizacion = '<tr data-expanded="false">' +
                        ...
                        '<td>' + cotizacionList[i].cliente_razonSocial + '</td>' +
                        '<td>' + cotizacionList[i].cliente_ruc + '</td>' +
