        ...
        $.ajax({
            ...
            success: function (facturaList) {
                ...
                for (var i = 0; i < facturaList.length; i++) {
                    ...
                    if (facturaList[i].usuario_apruebaAnulaciones && facturaList[i].solicitadoAnulacion
                    ...
                    if (facturaList[i].usuario_creaNotasCredito &&
                        (facturaList[i].estadoDocumentoSunat == 102 || facturaList[i].estadoDocumentoSunat == 103)
                    ) {
                    ...
                    var factura = '<tr data-expanded="false">'+
                        ...
                        '<td>  ' + facturaList[i].pedido_numeroPedidoString + '</td>' +
                        ...
                        '<td>  ' + facturaList[i].usuario_nombre + '</td>' +
                        '<td>  ' + invertirFormatoFecha(facturaList[i].fechaEmision.substr(0, 10)) + '</td>' +
                        '<td>  ' + facturaList[i].cliente_razonSocial + '</td>' +
                        '<td>  ' + facturaList[i].cliente_ruc + '</td>' +
                        '<td>  ' + facturaList[i].ciudad_nombre + '</td>' +
        ...
        */
        ...
        $.ajax({
            ...
            if (documentoVenta.tipoDocumento == CONS_TIPO_DOC_NOTA_CREDITO
                    ...
                    $("#pvDES_MTVO_NC_ND").html(documentoVenta.cPE_CABECERA_BE_DES_MTVO_NC_ND);
                ...
                $("#vpFEC_EMI_HOR_EMI").html(documentoVenta.cPE_CABECERA_BE_FEC_EMI + ' ' + documentoVenta.cPE_CABECERA_BE_HOR_EMI)
                $("#vpSERIE_CORRELATIVO").html(documentoVenta.cPE_CABECERA_BE_SERIE + ' ' + documentoVenta.cPE_CABECERA_BE_CORRELATIVO);

                /*NOMBRE COMERCIAL CLIENTE*/
                $("#vpNOM_RCT").html(documentoVenta.cPE_CABECERA_BE_NOM_RCT);

                /*DIRECCION - ORDEN DE COMPRA*/
                $("#vpDIR_DES_RCT").html(documentoVenta.cPE_CABECERA_BE_DIR_DES_RCT);
                $("#vpNRO_ORD_COM").html(documentoVenta.cPE_CABECERA_BE_NRO_ORD_COM);

                /*RUC - NRO GUIA*/
                $("#vpNRO_DOC_RCT").html(documentoVenta.cPE_CABECERA_BE_NRO_DOC_RCT);
                $("#vpNRO_GRE").html(documentoVenta.cPE_CABECERA_BE_NRO_GRE);
                ...
                $("#vpCORREO").html(documentoVenta.cPE_CABECERA_BE_CORREO_ENVIO);
                $("#vpCOND_PAGO").html(documentoVenta.tipoPagoString);
                $("#vpFEC_VCTO").html(documentoVenta.cPE_CABECERA_BE_FEC_VCTO);

                $("#vpMNT_TOT_GRV").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_GRV);
                $("#vpMNT_TOT_GRV_NAC").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_GRV_NAC);
                $("#vpMNT_TOT_INF").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_INF);
                $("#vpMNT_TOT_EXR").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_EXR);
                $("#vpMNT_TOT_GRT").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_GRT);
                $("#vpMNT_TOT_VAL_VTA").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_VAL_VTA);
                $("#vpMNT_TOT_TRB_IGV").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_TRB_IGV);
                $("#pvMNT_TOT_PRC_VTA").html(documentoVenta.cPE_CABECERA_BE_MNT_TOT_PRC_VTA);
