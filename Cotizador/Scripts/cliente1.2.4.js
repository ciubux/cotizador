   ...
   /* $("#tablefoottable").onSort(function () {
    ...
    $(document).on('click', "button.btnVerCliente", function () {
        ...
        $.ajax({
            ...
            success: function (cliente) {
                $('body').loadingModal('hide')
                $("#verCiudadNombre").html(cliente.ciudad_nombre);
                ...
                /*Vendedores*/
                $("#verResponsableComercial").html(cliente.responsableComercial_descripcion);
                $("#verSupervisorComercial").html(cliente.supervisorComercial_descripcion);
                $("#verAsistenteServicioCliente").html(cliente.asistenteServicioCliente_descripcion);


                $("#verGrupoCliente").html(cliente.grupoCliente_nombre)
