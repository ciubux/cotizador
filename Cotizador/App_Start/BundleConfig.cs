...
namespace Cotizador
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/ajusteAlmacen").Include(
            ...
            bundles.Add(new ScriptBundle("~/bundles/notaCreditoCompra").Include(
                        "~/Scripts/notaCreditoCompra.js"
                        ));
            ...
            bundles.Add(new ScriptBundle("~/bundles/clienteLite").Include(
            ...
            bundles.Add(new ScriptBundle("~/bundles/logcampo").Include(
                 "~/Scripts/logcampo1.0.0.js"));
