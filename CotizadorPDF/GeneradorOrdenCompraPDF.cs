...
{
    public class GeneradorOrdenCompraPDF
    {
        public String generarPDFExtended(Pedido obj)
        {
            ...
            try
            {
                ...
                page.Canvas.DrawImage(image, 335, 0, width, height);
                

                float y = 60;
                string mes = "";
                switch (obj.FechaRegistro.Month)
                {
