...
namespace FacturacionElectronica.ServicePSE {
    ...
    public partial class CPE_DETALLE_BE : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private FacturacionElectronica.ServicePSE.CPE_DETALLE_COMPTA_BE[] DES_COMPField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(Order=86)]
        public FacturacionElectronica.ServicePSE.CPE_DETALLE_COMPTA_BE[] DES_COMP {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServicePSE.IwsOnlineToCPE")]
    public interface IwsOnlineToCPE {
        ...
        FacturacionElectronica.ServicePSE.CPE_RESPUESTA_BE callProcessOnline(string oUser, string oPass, FacturacionElectronica.ServicePSE.CPE_CABECERA_BE oCabecera, FacturacionElectronica.ServicePSE.CPE_DETALLE_BE[] listDetalle, FacturacionElectronica.ServicePSE.CPE_DAT_ADIC_BE[] listAdicionales, FacturacionElectronica.ServicePSE.CPE_DOC_REF_BE[] listReferenciados, FacturacionElectronica.ServicePSE.CPE_ANTICIPO_BE[] listAnticipos, FacturacionElectronica.ServicePSE.CPE_FAC_GUIA_BE[] listFacGuia, FacturacionElectronica.ServicePSE.CPE_DOC_ASOC_BE[] listRelacionado, FacturacionElectronica.ServicePSE.GlobalEnumTipoOnline oTipoOnline);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IwsOnlineToCPE/callProcessOnline", ReplyAction="http://tempuri.org/IwsOnlineToCPE/callProcessOnlineResponse")]
        System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.CPE_RESPUESTA_BE> callProcessOnlineAsync(string oUser, string oPass, FacturacionElectronica.ServicePSE.CPE_CABECERA_BE oCabecera, FacturacionElectronica.ServicePSE.CPE_DETALLE_BE[] listDetalle, FacturacionElectronica.ServicePSE.CPE_DAT_ADIC_BE[] listAdicionales, FacturacionElectronica.ServicePSE.CPE_DOC_REF_BE[] listReferenciados, FacturacionElectronica.ServicePSE.CPE_ANTICIPO_BE[] listAnticipos, FacturacionElectronica.ServicePSE.CPE_FAC_GUIA_BE[] listFacGuia, FacturacionElectronica.ServicePSE.CPE_DOC_ASOC_BE[] listRelacionado, FacturacionElectronica.ServicePSE.GlobalEnumTipoOnline oTipoOnline);
        ...
        FacturacionElectronica.ServicePSE.RPTA_BE callStateCPE(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IwsOnlineToCPE/callStateCPE", ReplyAction="http://tempuri.org/IwsOnlineToCPE/callStateCPEResponse")]
        System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.RPTA_BE> callStateCPEAsync(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe);
        ...
        FacturacionElectronica.ServicePSE.RPTA_DOC_TRIB_BE callExtractCPE(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe, bool oFlgXml, bool oFlgPdf, bool oFlgCdr);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IwsOnlineToCPE/callExtractCPE", ReplyAction="http://tempuri.org/IwsOnlineToCPE/callExtractCPEResponse")]
        System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.RPTA_DOC_TRIB_BE> callExtractCPEAsync(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe, bool oFlgXml, bool oFlgPdf, bool oFlgCdr);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IwsOnlineToCPEChannel : FacturacionElectronica.ServicePSE.IwsOnlineToCPE, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IwsOnlineToCPEClient : System.ServiceModel.ClientBase<FacturacionElectronica.ServicePSE.IwsOnlineToCPE>, FacturacionElectronica.ServicePSE.IwsOnlineToCPE {
        ...
        public FacturacionElectronica.ServicePSE.CPE_RESPUESTA_BE callProcessOnline(string oUser, string oPass, FacturacionElectronica.ServicePSE.CPE_CABECERA_BE oCabecera, FacturacionElectronica.ServicePSE.CPE_DETALLE_BE[] listDetalle, FacturacionElectronica.ServicePSE.CPE_DAT_ADIC_BE[] listAdicionales, FacturacionElectronica.ServicePSE.CPE_DOC_REF_BE[] listReferenciados, FacturacionElectronica.ServicePSE.CPE_ANTICIPO_BE[] listAnticipos, FacturacionElectronica.ServicePSE.CPE_FAC_GUIA_BE[] listFacGuia, FacturacionElectronica.ServicePSE.CPE_DOC_ASOC_BE[] listRelacionado, FacturacionElectronica.ServicePSE.GlobalEnumTipoOnline oTipoOnline) {
        ...
        public System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.CPE_RESPUESTA_BE> callProcessOnlineAsync(string oUser, string oPass, FacturacionElectronica.ServicePSE.CPE_CABECERA_BE oCabecera, FacturacionElectronica.ServicePSE.CPE_DETALLE_BE[] listDetalle, FacturacionElectronica.ServicePSE.CPE_DAT_ADIC_BE[] listAdicionales, FacturacionElectronica.ServicePSE.CPE_DOC_REF_BE[] listReferenciados, FacturacionElectronica.ServicePSE.CPE_ANTICIPO_BE[] listAnticipos, FacturacionElectronica.ServicePSE.CPE_FAC_GUIA_BE[] listFacGuia, FacturacionElectronica.ServicePSE.CPE_DOC_ASOC_BE[] listRelacionado, FacturacionElectronica.ServicePSE.GlobalEnumTipoOnline oTipoOnline) {
        ...
        public FacturacionElectronica.ServicePSE.RPTA_BE callStateCPE(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe) {
            return base.Channel.callStateCPE(oUser, oPass, oNroIde, oTipCpe, oSerCpe, oNroCpe);
        }
        
        public System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.RPTA_BE> callStateCPEAsync(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe) {
            return base.Channel.callStateCPEAsync(oUser, oPass, oNroIde, oTipCpe, oSerCpe, oNroCpe);
        }
        
        public FacturacionElectronica.ServicePSE.RPTA_DOC_TRIB_BE callExtractCPE(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe, bool oFlgXml, bool oFlgPdf, bool oFlgCdr) {
            return base.Channel.callExtractCPE(oUser, oPass, oNroIde, oTipCpe, oSerCpe, oNroCpe, oFlgXml, oFlgPdf, oFlgCdr);
        }
        
        public System.Threading.Tasks.Task<FacturacionElectronica.ServicePSE.RPTA_DOC_TRIB_BE> callExtractCPEAsync(string oUser, string oPass, string oNroIde, string oTipCpe, string oSerCpe, string oNroCpe, bool oFlgXml, bool oFlgPdf, bool oFlgCdr) {
