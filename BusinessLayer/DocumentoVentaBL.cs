...
namespace BusinessLayer
{
    public class DocumentoVentaBL
    {
        ...
        public DocumentoVenta IniciarFacturaPedidoRelacionado(Guid idGuiaOriginal, Guid idUsuario, out Guid idGuiaFic, out Guid idVentaFic,
            out Guid idCPE)
        {
            ...
            using (var dal = new DocumentoVentaDAL())
            {
                ...
                dal.IniciarFacturaPedidoRelacionado(idGuiaOriginal, idUsuario, out idGuiaFic, out idVentaFic, out idCPE, 
        ...
        public DocumentoVenta FacturacionPedidoRelacionado(Guid idGuiaOriginal, Guid idUsuario, out Guid idGuiaFic, out Guid idVentaFic,
            out Guid idCPE)
        {
            DocumentoVenta documentoVenta = new DocumentoVenta();
            using (var dal = new DocumentoVentaDAL())
            {
                ...
                dal.FacturacionPedidoRelacionado(idGuiaOriginal, idUsuario, out idGuiaFic, out idVentaFic, out idCPE,
                        out TipoError, out descripcionError);
        ...
        public DocumentoVenta IniciarExtornoGuiaRealPedidoRelacionado(Guid idMovIngresoFicticio, Guid idUsuario, out Guid idNotaIngreso, 
                        out Guid idVentaIngreso, out Guid idCPE)
        {
            DocumentoVenta documentoVenta = new DocumentoVenta();
            using (var dal = new DocumentoVentaDAL())
            {
                ...
                dal.IniciarExtornoGuiaRealPedidoRelacionado(idMovIngresoFicticio, idUsuario, out idNotaIngreso, out idVentaIngreso, out idCPE,
                        out TipoError, out descripcionError);
